  ...
  (s.n = (e) => {
    ...
    (() => {
      var e = s(89),
        ...
        i = s(634);
      const c = JSON.parse(
          '["vinnora\\\\.com(?:/.*)?/ola/services/.*","vinnora\\\\.com/ola/meetings/.*","/api/","https://api\\\\.ola\\\\.godaddy\\\\.com","https://0f4006ba-2428-4778-8140-f1bfcedff216\\\\.onlinestore\\\\.godaddy\\\\.com","/t/1/tl/event","google-analytics\\\\.com/collect","calendar\\\\.apps\\\\.(dev-|test-)?secureserver\\\\.net"]'
        ).map((e) => new RegExp(e)),
        o = JSON.parse(
          '["vinnora\\\\.com(?:/.*)?/f/.*","https://blog\\\\.apps\\\\.secureserver\\\\.net/v1/website/0f4006ba-2428-4778-8140-f1bfcedff216/feed/post/","https://blog\\\\.apps\\\\.secureserver\\\\.net/v1/website/0f4006ba-2428-4778-8140-f1bfcedff216/feed"]'
        ).map((e) => new RegExp(e)),
        h = JSON.parse(
          '["/","/#0238dc69-be3d-4ed0-a555-c6461509422c","/#ba1fc343-cf9a-4434-bb57-daaba078bb07","/#4b863210-e363-4dac-ab23-73bf55e7bf1c","/#9348b19c-e100-4b57-87f3-917139bec823"]'
        ).map((e) => ({ url: e, revision: "1747932022894" }));
      self.addEventListener("activate", function (e) {
        e.waitUntil(
          caches.keys().then(function (e) {
            return Promise.all(
              e
                .filter((e) => e.startsWith("vinnora.com-"))
